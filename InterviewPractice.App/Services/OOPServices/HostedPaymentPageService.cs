...
public class HostedPaymentPageService : PaymentBase
{
    public override PaymentMethod PaymentMethod { get;} = PaymentMethod.SecurePage;
    ...
    {
        Console.WriteLine("Redirecting to secure payment page...");
    }
